...
namespace ArcaneOdyssey.Content.Buffs.MagicMarks
{
	public class CrystalStackIIII : Base.AODebuff 
	{
		 public override void Update(NPC npc, ref int buffIndex) {
			...
			{
					if (Main.netMode != NetmodeID.Server) Dust.NewDust(npc.position+ new Vector2((float)npc.width/2f,(float)npc.height/2f),1,1,DustID.GemRuby,(0.5f-Main.rand.NextFloat())*5f,(0.1f-Main.rand.NextFloat())*5f,1,default,2f);
			}
