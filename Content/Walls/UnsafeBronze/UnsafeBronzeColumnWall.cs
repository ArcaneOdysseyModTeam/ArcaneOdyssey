...
namespace ArcaneOdyssey.Content.Walls.UnsafeBronze
{
	public class UnsafeBronzeColumnWall : ModWall
	{
		public override string Texture => AOUtils.GetTexture<BronzeColumnWall>();
