...
namespace ArcaneOdyssey.Content.Projectiles
{
	public class MagicCircle : AOPlayerProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Main.EntitySpriteDraw(MagicCircleSprite, Projectile.Center-Main.screenPosition, new Rectangle(0, 64 * Projectile.frame, 62, 64), drawColor, Projectile.rotation, new Vector2(31f, 32f), thisMagic.AOMagicSize*Projectile.scale, SpriteEffects.None, 0);
			return false;
		}
	}
}
