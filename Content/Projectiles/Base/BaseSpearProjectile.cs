...
namespace ArcaneOdyssey.Content.Projectiles.Base
{
	public abstract class BaseSpearProjectile : AOPlayerProjectile
	{
		...
		public override void ModifyDamageHitbox(ref Rectangle hitbox)
		{
			...
			Projectile.scale = 1f * (originalItem.ModItem is AOWeapon weap ? weap.AOSize : 1) * (playah.imbue is not null ? playah.imbue.AOImbueSize : 1);
			...
			hitbox.Width = (int)(hitbox.Width * (originalItem.ModItem is AOWeapon weap3 ? weap3.AOSize : 1) * (playah.imbue is not null ? playah.imbue.AOImbueSize : 1));
		}
	}
}
