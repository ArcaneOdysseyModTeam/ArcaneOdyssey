...
namespace ArcaneOdyssey.Content.Items.Magic
{
	public class PoisonLightningMagic : AOMagic
	{
		...
		public override MagicEffects Effects => new MagicEffects(
			...
			public override Dictionary<Type, int> Spells => new Dictionary<Type, int>([KeyValuePair.Create(typeof(BlastSpell), ModContent.ProjectileType<PoisonLightningBlast>()),]);
