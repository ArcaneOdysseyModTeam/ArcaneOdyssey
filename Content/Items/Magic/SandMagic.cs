...
namespace ArcaneOdyssey.Content.Items.Magic
{
	public class SandMagic : AOMagic
    {
		...
		public override Dictionary<Type, int> Skills => new([KeyValuePair.Create(typeof(BlastSpell), ModContent.ProjectileType<SandBlast>()), KeyValuePair.Create(typeof(CannonSpell), ModContent.ProjectileType<SandCannon>())]);
	}
}