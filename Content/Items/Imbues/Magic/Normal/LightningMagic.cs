...
namespace ArcaneOdyssey.Content.Items.Imbues.Magic.Normal
{
	public class LightningMagic : AOMagic
	{
		...
		public override void LingeringEffects(Rectangle area, Vector2? direction = null, Entity source = null)
		{
			...
			Dust spawnedDust = Dust.NewDustPerfect(area.Center() + baseVec.RotatedBy(direction.GetValueOrDefault(Vector2.One).ToRotation()), DustID.CrystalPulse, Scale: 1.2f * area.RelativeScale());
