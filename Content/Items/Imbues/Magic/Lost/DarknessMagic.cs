	...
	public class DarknessMagic : AOMagic
	{
		...
		public override void SpawningEffects(Entity projectile)
		{
			for (int n = 0; n < 2; n++)
			{
                ...
                Dust spawnedDust2 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.VampireHeal, projectile.velocity.X * 2f, projectile.velocity.Y * 2f)];
		...
		public override void LingeringEffects(Entity projectile)
		{
			if (Main.GameUpdateCount % 2 == 0)
			{
				...
				spawnedDust.noGravity = true;
				Dust spawnedDust2 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.VampireHeal, 0f, 0f, 0, default, .9f)];
				spawnedDust2.noGravity = true;
			}
		}
		...
		public override void ExplosionEffects(Entity projectile)
		{
			for (int n = 0; n < 2; n++)
			{
				...
				spawnedDust.noGravity = true;
				Dust spawnedDust2 = Main.dust[Dust.NewDust(projectile.Center, 1, 1, DustID.VampireHeal, (Main.rand.NextFloat() - 0.5f) * (35f * AOScrollSize), (Main.rand.NextFloat() - 0.5f) * (35f * AOScrollSize))];
				spawnedDust2.noGravity = true;
			}
		}
		...
		public override void KillEffects(Entity projectile)
		{
			for (int n = 0; n < 6; n++)
			{
				...
				spawnedDust.noGravity = true;
				Dust spawnedDust2 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.VampireHeal, 8f * (Main.rand.NextFloat() - 0.5f), 8f * (Main.rand.NextFloat() - 0.5f))];
				spawnedDust2.noGravity = true;
			}
