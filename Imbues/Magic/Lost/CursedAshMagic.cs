...
namespace ArcaneOdyssey.Imbues.Magic.Lost
{
	public class CursedAshMagic : MagicType
	{
		...
		public override float ImbueSpeed => 0.975f * 1.1f;
		public override float ImbueSize => 1.22f * 1.1f;
		public override float ImbueDamage => 0.95f * 1.1f;
		public override float ScrollSpeed => 0.95f * 1.1f;
		public override float ScrollSize => 1.25f * 1.1f;
		public override float ScrollDamage => 0.875f * 1.1f;
