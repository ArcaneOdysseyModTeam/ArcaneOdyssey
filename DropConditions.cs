...
namespace ArcaneOdyssey
{
	public class FirstCultistKill : IItemDropRuleCondition
	{
		...
		public string GetConditionDescription() => Language.GetOrRegister($"Mods.{ArcaneOdyssey.InternalName}.FirstCultistKillDescription", () => "First Lunatic Cultist Defeated").Value;
	}
	...
	public class FirstMoonLordKill : IItemDropRuleCondition
	{
		...
		public bool CanShowItemDropInUI() => true;
		public string GetConditionDescription() => Language.GetOrRegister($"Mods.{ArcaneOdyssey.InternalName}.FirstMoonLordKillDescription", () => "First Moon Lord Defeated").Value;
	}
	...
	public class FirstEmpressKill : IItemDropRuleCondition
	{
		...
		public bool CanShowItemDropInUI() => true;
		public string GetConditionDescription() => Language.GetOrRegister($"Mods.{ArcaneOdyssey.InternalName}.FirstEmpressKillDescription", () => "First Empress of Light Defeated").Value;
    }
    ...
    public class FirstEvanderKill : IItemDropRuleCondition
    {
        ...
        public bool CanShowItemDropInUI() => true;
        public string GetConditionDescription() => Language.GetOrRegister($"Mods.{ArcaneOdyssey.InternalName}.FirstEvanderKillDescription", () => "First Evander Defeated").Value;
    }
    public class NotFirstEvanderKill : IItemDropRuleCondition
    {
        public bool CanDrop(DropAttemptInfo info) => DownedBosses.downedEvander;
        public bool CanShowItemDropInUI() => true;
        public string GetConditionDescription() => Language.GetOrRegister($"Mods.{ArcaneOdyssey.InternalName}.NotFirstEvanderKillDescription", () => "Following Evanders Defeated").Value;
    }
    ...
    public class FirstDayEmpressKill : IItemDropRuleCondition
	{
		...
		public bool CanShowItemDropInUI() => true;
		public string GetConditionDescription() => Language.GetOrRegister($"Mods.{ArcaneOdyssey.InternalName}.FirstDayEmpressKillDescription", () => "First Enraged Empress of Light Defeated").Value;
	}
